  ...
  <section className="md:bg-center bg-cover bg-no-repeat sm:bg-[url('/banner1.jpg')] bg-[url('/banner4.jpg')] bg-gray-700 sm:bg-gray-400 bg-blend-multiply">
    <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-transparent border border-[#ffa000] transition hover:bg-[#ffa000] focus:ring-4 outline-[#ffa000]">
                Browse Listings
